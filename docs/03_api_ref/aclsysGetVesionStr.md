...
根据软件包名称查询版本号，版本号是字符串类型，与各包安装目录下的version.info文件中的version保持一致。
...
<td class="cellrowborder" valign="top" width="67.80000000000001%" headers="mcps1.1.4.1.3 "><p id="p123961002578">版本号。</p><p>
    ...
    <pre class="screen" id="screen188918273533">#define ACL_PKG_VERSION_MAX_SIZE  128</pre>
    </p>
</td>
</tr>
