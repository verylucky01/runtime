...
namespace cce {
namespace runtime {
static void MacroInitMC32DM11A(rtSocType_t socType, RtMacroValue &value)
{
    UNUSED(socType);
...
static DevDynInfoProcFunc CHIP_MC32DM11A_PROC_FUNC = {
    .macroInitFunc = &MacroInitMC32DM11A,
};

REGISTER_DEV_INFO_PROC_FUNC(CHIP_MC32DM11A, CHIP_MC32DM11A_PROC_FUNC);
}
}