...
constexpr rtSocInfo_t DEV_INFO_MC_62[] = {
    {CHIP_MC62CM12A, "MC62CM12AA"},
    {CHIP_MC62CM12A, "MC62CM12AC"},
    {CHIP_MC62CM12A, "MC62CM12AD"},
    {CHIP_MC62CM12A, "MC62CM12AE"},
    {CHIP_MC62CM12A, "MC62CM12AF"},
    {CHIP_MC62CM12A, "MC62CM13AA"},
    {CHIP_MC62CM12A, "MC62CM13AB"},
    {CHIP_MC62CM12A, "MC62CM22AA"},
    {CHIP_MC62CM12A, "MC62CM22AC"},
    {CHIP_MC62CM12A, "MC62CM22AD"},
    {CHIP_MC62CM12A, "MC62CM22AE"},
    {CHIP_MC62CM12A, "MC62CM22AF"},
    {CHIP_MC62CM12A, "MC62CM23AA"},
    {CHIP_MC62CM12A, "MC62CM23AB"},
};

BATCH_REGISTER_DEV_INFO(DEV_INFO_MC_62, sizeof(DEV_INFO_MC_62) / sizeof(rtSocInfo_t));

REGISTER_PLATFORM_LIB_INFO(CHIP_MC62CM12A, "libruntime_v201.so");

static const std::unordered_set<RtOptionalFeatureType> CHIP_MC62CM12A_FEATURE{
