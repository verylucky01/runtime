...
namespace cce {
namespace runtime {
static void MacroInitMiniV3(rtSocType_t socType, RtMacroValue &value)
{
    UNUSED(socType);
    ...
    value.stubEventCount = 65536U; // event cache 64K,
...
static DevDynInfoProcFunc CHIP_MINI_V3_PROC_FUNC = {
    .macroInitFunc = &MacroInitMiniV3,
};

REGISTER_DEV_INFO_PROC_FUNC(CHIP_MINI_V3, CHIP_MINI_V3_PROC_FUNC);
}
}