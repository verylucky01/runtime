...
namespace runtime {
// 1910b tiny
static void MacroInitMini5612(rtSocType_t socType, RtMacroValue &value)
{
    UNUSED(socType);
    value.maxPersistTaskNum = 65535U;
    value.maxTaskNumPerStream = 2010U;
    value.maxSinkTaskNum = 1000000U;
    value.maxSupportTaskNum = 2000000U;
    value.pctraceFileLength = (4U * 1024U) + 6U;
    value.maxAllocStreamNum = 480U;
...
static DevDynInfoProcFunc CHIP_5612_PROC_FUNC = {
    .macroInitFunc = &MacroInitMini5612,
};

REGISTER_DEV_INFO_PROC_FUNC(CHIP_ASCEND_031, CHIP_5612_PROC_FUNC);
}
}