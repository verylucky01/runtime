...
class MSPROF_ACL_CORE_OPEN_UTEST: public testing::Test {
public:
    void RegisterTryPop() {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, get_op_xxx) {
    ProfOpDesc data;
    data.modelId = 0;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, acl_ge_api) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, aclgrphProfInit_failed) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ProfAclInit_failed) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, acl_api) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, prof_acl_api_helper) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, acl_prof_init_failed) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, aclprofCreateSubscribeConfig) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, acl_api_subscribe) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ge_api_subscribe) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AclProfGETSetpInfoApiTest) {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, acl_app) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, acl_json) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ge_option) {
    GlobalMockObject::verify();
    MOCKER_CPP(&Analysis::Dvvp::Common::Config::ConfigManager::GetPlatformType)
        .stubs()
        .will(returnValue(PlatformType::CHIP_V4_1_0));
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, PureCpu) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, init_env) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, mode_protect) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofTxSwitchPrecheck) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
    ProfAclMgr::instance()->mode_ = WORK_MODE_CMD;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofTxApiHandle) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofTxHandle) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofHostSysHandle) {
    using namespace Msprofiler::Api;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, DoHostHandle) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, HandleProfilingParams) {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, OpDescParserNullptr) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, RecordOutPut) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, InitApiCtrlUploaderHelper) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, RecordOutPut2) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, EnableRpcHelperMode) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofInitAclJson) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
    MOCKER_CPP(&Analysis::Dvvp::Common::Config::ConfigManager::GetPlatformType)
        .stubs()
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofCheckAndGetChar) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofInitGeOptionsParamAdaper) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofGeOptionsResultPathAdapter) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofInitGeOptions) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
    MOCKER_CPP(&Analysis::Dvvp::Common::Config::ConfigManager::GetPlatformType)
        .stubs()
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofInitGeOptionsWithErrJsonStr) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofAclJsonParamConstruct) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofResultDirAdapter) {
    GlobalMockObject::verify();
    Msprofiler::Api::ProfAclMgr profAclMgr;
    std::string dir = "";
    std::string work_path = "/tmp/ascend_work_path/";
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofGeOptionsParamConstruct) {
    GlobalMockObject::verify();
    Msprofiler::Api::ProfAclMgr profAclMgr;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofInitHelper) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofInitPureCpu) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofHostHandle) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
    MOCKER_CPP(&Analysis::Dvvp::Common::Platform::Platform::PlatformIsHelperHostSide)
        .stubs()
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ReporterApiData) {
    GlobalMockObject::verify();
    using namespace Msprof::Engine;
    ReceiveData rData;
    uint32_t age = 1;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ReporterCompactData) {
    GlobalMockObject::verify();
    using namespace Msprof::Engine;
    ReceiveData rData;
    uint32_t age = 1;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ReporterAdditionalData) {
    GlobalMockObject::verify();
    using namespace Msprof::Engine;
    ReceiveData rData;
    uint32_t age = 1;
...
void *BatchPopStubNull(size_t &popSize, bool popForce)
{
    (void)popSize;
    (void)popForce;
    return nullptr;
...
std::shared_ptr<BlockBuffer<MsprofAdditionalInfo>> g_bq(new BlockBuffer<MsprofAdditionalInfo>());
void *TryPopAdprofBufStub(size_t &popSize, bool popForce)
{
    return g_bq->BatchPop(popSize, popForce);
}

void TryIndexShiftAdprofBufStub(void *popPtr, const size_t popSize)
{
    g_bq->BatchPopBufferIndexShift(popPtr, popSize);
}

TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ReporterDevProfAdditionalData) {
    GlobalMockObject::verify();
    using namespace Msprof::Engine;
    ReceiveData rData;
    rData.moduleName_ = "adprof";
    rData.moduleId_ = ADPROF;
    rData.Init();
    ReceiveData::batchAdditionalTryPop_ = BatchPopStubNull;
    std::vector<std::shared_ptr<analysis::dvvp::ProfileFileChunk> > fileChunksVec = {};
    rData.RunProfileData(fileChunksVec);
    EXPECT_EQ(0, fileChunksVec.size());
    // using block buffer
    std::string name = "BaseBlockBufferTest";
    EXPECT_EQ(true, g_bq->Init(name, 4096));
    // push aicpu data
    MsprofAdditionalInfo data;
    data.level = 6000; // aicpu
    data.type = 2;
    data.timeStamp = 151515151;
    g_bq->BatchPush(&data, sizeof(MsprofAdditionalInfo));
    EXPECT_EQ(1, g_bq->GetUsedSize());
    // push hccl data
    data.level = 5500; // hccl
    data.type = 10;
    data.timeStamp = 131313131;
    g_bq->BatchPush(&data, sizeof(MsprofAdditionalInfo));
    EXPECT_EQ(2, g_bq->GetUsedSize());
    // set pop ptr
    ReceiveData::batchAdditionalTryPop_ = TryPopAdprofBufStub;
    ReceiveData::batchAdditionalBufferIndexShift_ = TryIndexShiftAdprofBufStub;
    rData.RunProfileData(fileChunksVec);
    EXPECT_EQ(1, fileChunksVec.size());

    const char *infoData = fileChunksVec[0]->chunk.c_str();
    const MsprofAdditionalInfo *aicpuInfo = reinterpret_cast<const MsprofAdditionalInfo *>(infoData);
    const MsprofAdditionalInfo *hcclInfo = reinterpret_cast<const MsprofAdditionalInfo *>(infoData + 256);
    EXPECT_EQ(6000, aicpuInfo->level);
    EXPECT_EQ(2, aicpuInfo->type);
    EXPECT_EQ(151515151, aicpuInfo->timeStamp);
    EXPECT_EQ(5500, hcclInfo->level);
    EXPECT_EQ(10, hcclInfo->type);
    EXPECT_EQ(131313131, hcclInfo->timeStamp);
    g_bq->UnInit();
}

TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AddToUploaderGetUploaderFailed) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, Analyzer_TsDataPostProc) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, Analyzer_Ffts_PrintStats) {
    std::shared_ptr<Analyzer> analyzer(new Analyzer(nullptr));
    analyzer->analyzerFfts_->PrintStats();
}

TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, Analyzer_UploadTsOp) {
    GlobalMockObject::verify();
    MOCKER_CPP(&Analysis::Dvvp::Analyze::Analyzer::ConstructAndUploadData)
        .stubs();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, InitFrequency) {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, Buffer_RemainingData) {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerRt_Parse) {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerRt_HandleUnAgingRuntimeTrackData) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerRt_MatchDeviceOpInfo) {
    GlobalMockObject::verify();
    std::shared_ptr<AnalyzerRt> analyzerRt(new AnalyzerRt());
    analyzerRt->rtOpInfo_ = {};
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerRt_MatchDeviceOpInfoNotMatch) {
    GlobalMockObject::verify();
    std::shared_ptr<AnalyzerRt> analyzerRt(new AnalyzerRt());
    analyzerRt->rtOpInfo_ = {};
    analyzerRt->tsTmpOpInfo_ = {};
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerHwts_HandleOptimizeStartEndData) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerFfts_OptimizeParse) {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerFfts_HandleOptimizeStartEndData) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerFfts_HandleOptimizeStartEndData_david) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerFfts_HandleOptimizeSubTaskThreadData) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_CompactParse) {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_CcontextParse) {
    std::shared_ptr<Analysis::Dvvp::Analyze::AnalyzerGe> analyzerGe(new Analysis::Dvvp::Analyze::AnalyzerGe());
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_UnAgingEventParse) {
    std::shared_ptr<Analysis::Dvvp::Analyze::AnalyzerGe> analyzerGe(new Analysis::Dvvp::Analyze::AnalyzerGe());
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_AgingEventParse) {
    std::shared_ptr<Analysis::Dvvp::Analyze::AnalyzerGe> analyzerGe(new Analysis::Dvvp::Analyze::AnalyzerGe());
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_UnAgingApiParse) {
    std::shared_ptr<Analysis::Dvvp::Analyze::AnalyzerGe> analyzerGe(new Analysis::Dvvp::Analyze::AnalyzerGe());
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_AgingApiParse) {
    std::shared_ptr<Analysis::Dvvp::Analyze::AnalyzerGe> analyzerGe(new Analysis::Dvvp::Analyze::AnalyzerGe());
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_HandleNodeBasicInfo) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_HandleApiInfo) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_HandleModelInfo) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_MatchDeviceInfo) {
    GlobalMockObject::verify();
    std::shared_ptr<AnalyzerGe> analyzerGe(new AnalyzerGe());
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_MatchApiInfo) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, Analyzer_GetOpIndexId) {
    std::shared_ptr<Analyzer> analyzer(new Analyzer(nullptr));
    TsProfileKeypoint data;
    data.head.bufSize = sizeof(TsProfileKeypoint);
    data.indexId = 1234;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, Analyzer_UpdateTsOpIndexId) {
    std::shared_ptr<Analyzer> analyzer(new Analyzer(nullptr));
    TsProfileKeypoint data;
    data.head.bufSize = sizeof(TsProfileKeypoint);
    data.taskId = 1;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, Analyzer_DispatchOptimizeData) {
    std::shared_ptr<Analyzer> analyzer(new Analyzer(nullptr));
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, Analyzer_UploadProfOpDescProc) {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, Analyzer_UploadOptimizeData) {
    GlobalMockObject::verify();
    GeOpFlagInfo geInfo;
    RtOpInfo rtInfo;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerTs_UploadKeypointOp) {
    GlobalMockObject::verify();
    MOCKER_CPP(&Analysis::Dvvp::Analyze::Analyzer::ConstructAndUploadData)
        .stubs();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerTs_UploadKeypointOp2) {
    GlobalMockObject::verify();
    MOCKER_CPP(&Analysis::Dvvp::Analyze::Analyzer::ConstructAndUploadData)
        .stubs();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_GetStreamType) {
    GlobalMockObject::verify();
    MOCKER_CPP(&Analysis::Dvvp::Analyze::Analyzer::ConstructAndUploadData)
        .stubs();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AnalyzerGe_ParsOpData) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AicoreMetricsEnumToName) {
    std::string metrics;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, TaskBasedCfgTrfToReq) {
    std::string metrics;
    MOCKER_CPP(&Analysis::Dvvp::Common::Config::ConfigManager::GetPlatformType)
        .stubs()
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, acl_api_subscribe_fail) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, StartUploaderDumper_fail) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ProfStartAscendProfHalTask) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
    ProfConfig config;
    config.devNums = 1;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ProfStartAscendProfHalTask_Helper) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
    ProfConfig config;
    config.devNums = 1;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ProfAclStartMultiDevice) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, acl_ge_api_success) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, acl_api_success) {
    GlobalMockObject::verify();
    MOCKER(dlopen).stubs().will(returnValue((void *)nullptr));
    MOCKER(dlsym).stubs().will(invoke(dlsymSuccessStub));
    ProfRtAPI::ExtendPlugin::instance()->LoadProfApi();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, acl_api_notsupport) {
    GlobalMockObject::verify();
    MOCKER(dlopen).stubs().will(returnValue((void *)nullptr));
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, acl_api_failed) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, FinalizeHandle_CheckFalseMode) {
    using namespace Msprofiler::Api;
    ProfAclMgr::instance()->mode_ = WORK_MODE_OFF;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, FinalizeHandle_CheckTrueMode) {
    using namespace Msprofiler::Api;
    ProfAclMgr::instance()->mode_ = WORK_MODE_CMD;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, aclprofSetConfig_not_support) {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, IsValidProfConfig) {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, IsValidProfConfig1) {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, IsProfConfigValid) {
    GlobalMockObject::verify();
    ProfConfig config;
    config.devNums = 5;
    config.devIdList[0] = 0;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, IsProfConfigValidSecond) {
    ProfConfig config;
    config.devNums = 1;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ProfStop) {
    ProfConfig config;
    config.devNums = 1;
    config.devIdList[0] = 0;
    config.aicoreMetrics = PROF_AICORE_ARITHMETIC_UTILIZATION;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, CreateParserTransport)
{
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ProfNotifySetDeviceForDynProf)
{
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, SetHelperDirToTransport)
{
    GlobalMockObject::verify();
    MOCKER(&Utils::GetPid)
        .stubs()
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, SendHelperDataWithValidUploader)
{
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, SendHelperDataWithInvalidUploader)
{
    GlobalMockObject::verify();
    SHARED_PTR_ALIA<analysis::dvvp::ProfileFileChunk> fileChunkReq(new analysis::dvvp::ProfileFileChunk());
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, ProcessHelperHostConfig)
{
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, UpdateOpFeature) {
    GlobalMockObject::verify();
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, AddCcuInstructionTest) {
    GlobalMockObject::verify();
    MOCKER_CPP(&Platform::CheckIfSupport, bool (Platform::*)(const PlatformFeature) const)
        .stubs()
        .will(returnValue(false))
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, CommandHandleFinalizeGuard_Base) {
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofStart_PureCpu) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofStart_Common) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofStart_AclApi) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
    MOCKER_CPP(&ProfAclMgr::GetDevicesNotify)
        .stubs()
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, MsprofStart_AclSubscribe) {
    GlobalMockObject::verify();
    using namespace Msprofiler::Api;
...
TEST_F(MSPROF_ACL_CORE_OPEN_UTEST, Msprof_aclprofGetSupportedFeatures) {
