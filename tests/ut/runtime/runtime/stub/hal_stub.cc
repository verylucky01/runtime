...
drvError_t halCentreNotifyGet(int index, int *value)
{
    return DRV_ERROR_NONE;
}
...
drvError_t halDrvEventThreadInit(const uint32_t dev_id)
{
    return DRV_ERROR_NONE;
}