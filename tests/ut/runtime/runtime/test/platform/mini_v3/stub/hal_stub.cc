    ...
    switch (type) {
        case DRV_NORMAL_TYPE: {
            ...
            if (prop == DRV_SQCQ_PROP_SQ_HEAD) {
                ...
                info->value[0] = 1;
            } else if (prop == DRV_SQCQ_PROP_SQ_CQE_STATUS) {
                info->value[0] = 0;
            }
            break;
        }
